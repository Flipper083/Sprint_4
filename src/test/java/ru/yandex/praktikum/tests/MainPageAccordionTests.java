...
public class MainPageAccordionTests {
    ...
    /** Тест для проверки отображения элемента аккордеона */
    ...
    public void checkAccordionItemIsDisplayed() {
        ...
        MatcherAssert.assertThat("Accordion header item #" + this.numberOfElement + " didn't load",
                mainPage.isAccordionItemDisplayed(this.numberOfElement), equalTo(true));
    }

    /** Тест для проверки текста в заголовках и в раскрывающихся блоках */
    ...
    public void checkAccordionTextIsCorrect() {
        ...
        MatcherAssert.assertThat("Problems with text in accordion header #" + this.numberOfElement,
                mainPage.getAccordionHeaderText(this.numberOfElement), // Фактический текст
                equalTo(this.expectedHeaderText) // Ожидаемый текст
        );
        ...
        MatcherAssert.assertThat("Problems with text in accordion item #" + this.numberOfElement,
                mainPage.getAccordionItemText(this.numberOfElement), // Фактический текст
                equalTo(this.expectedItemText) // Ожидаемый текст
        );
    }
}